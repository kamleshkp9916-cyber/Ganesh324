...
const defaultTransactions: Transaction[] = [
    ...
    { id: 3, transactionId: 'REF-MOCK5678', type: 'Refund', description: 'For cancelled order #MOCK5678', date: 'Sep 08, 2025', time: '09:00 AM', amount: 5200.00, avatar: 'https://placehold.co/40x40.png?text=R', status: 'Completed', paymentMethod: 'Wallet', gatewayTransactionId: 'REF-GHI789DEF' },
