...
const mockSellers: Record<string, UserData> = {
    ...
    'gadgetguru-uid': { uid: 'gadgetguru-uid', publicId: 'S-0002', displayName: 'GadgetGuru', email: 'guru@gadgets.com', photoURL: 'https://placehold.co/128x128.png?text=G', role: 'seller', followers: 2500, following: 50, bio: 'Latest and greatest in tech reviewed.', location: 'San Francisco, USA', phone: '', addresses: [], color: '#ffffff', twitter: 'https://twitter.com/gadgetguru', verificationStatus: 'verified' },
    'homehaven-uid': { uid: 'homehaven-uid', publicId: 'S-0003', displayName: 'HomeHaven', email: 'contact@homehaven.com', photoURL: 'https://placehold.co/128x128.png?text=H', role: 'seller', followers: 850, following: 200, bio: 'Making your house a home, one decor piece at a time.', location: 'Stockholm, Sweden', phone: '', addresses: [], color: '#ffffff', verificationStatus: 'verified' },
    'beautybox-uid': { uid: 'beautybox-uid', publicId: 'S-0004', displayName: 'BeautyBox', email: 'info@beautybox.com', photoURL: 'https://placehold.co/128x128.png?text=B', role: 'seller', followers: 3100, following: 80, bio: 'Your one-stop shop for cosmetics and skincare.', location: 'Seoul, South Korea', phone: '', addresses: [], color: '#ffffff', youtube: 'https://youtube.com/beautybox', verificationStatus: 'verified' },
    'kitchenwiz-uid': { uid: 'kitchenwiz-uid', publicId: 'S-0005', displayName: 'KitchenWiz', email: 'support@kitchenwiz.com', photoURL: 'https://placehold.co/128x128.png?text=K', role: 'seller', followers: 975, following: 120, bio: 'Innovative tools for the modern chef.', location: 'Milan, Italy', phone: '', addresses: [], color: '#ffffff', verificationStatus: 'verified' },
    'fitflow-uid': { uid: 'fitflow-uid', publicId: 'S-0006', displayName: 'FitFlow', email: 'getfit@fitflow.com', photoURL: 'https://placehold.co/128x128.png?text=F', role: 'seller', followers: 1500, following: 300, bio: 'Activewear and equipment for your fitness journey.', location: 'Los Angeles, USA', phone: '', addresses: [], color: '#ffffff', verificationStatus: 'verified' },
    'artisanalley-uid': { uid: 'artisanalley-uid', publicId: 'S-0007', displayName: 'ArtisanAlley', email: 'hello@artisanalley.com', photoURL: 'https://placehold.co/128x128.png?text=A', role: 'seller', followers: 450, following: 450, bio: 'Handcrafted goods with a story.', location: 'Kyoto, Japan', phone: '', addresses: [], color: '#ffffff', verificationStatus: 'verified' },
    'petpalace-uid': { uid: 'petpalace-uid', publicId: 'S-0008', displayName: 'PetPalace', email: 'woof@petpalace.com', photoURL: 'https://placehold.co/128x128.png?text=P', role: 'seller', followers: 1800, following: 220, bio: 'Everything your furry friends could ever want.', location: 'London, UK', phone: '', addresses: [], color: '#ffffff', verificationStatus: 'verified' },
    'booknook-uid': { uid: 'booknook-uid', publicId: 'S-0009', displayName: 'BookNook', email: 'read@booknook.com', photoURL: 'https://placehold.co/128x128.png?text=B', role: 'seller', followers: 620, following: 500, bio: 'A cozy corner for book lovers.', location: 'Edinburgh, Scotland', phone: '', addresses: [], color: '#ffffff', verificationStatus: 'verified' },
    'gamerguild-uid': { uid: 'gamerguild-uid', publicId: 'S-0010', displayName: 'GamerGuild', email: 'gg@gamerguild.com', photoURL: 'https://placehold.co/128x128.png?text=G', role: 'seller', followers: 4200, following: 10, bio: 'Top-tier gaming gear and accessories.', location: 'Taipei, Taiwan', phone: '', addresses: [], color: '#ffffff', twitch: 'https://twitch.tv/gamerguild', verificationStatus: 'verified' },
