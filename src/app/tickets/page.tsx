...
function RaiseTicketContent() {
    ...
    const [tickets, setTickets] = useLocalStorage<(Inquiry & {id: string, userId?: string, lastUpdate: string})[]>(TICKET_STORAGE_KEY, mockTickets);
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        ...
                                        <SelectContent>{ticketCategories.map(cat => <SelectItem key={cat} value={cat}>{cat}</SelectItem>)}</SelectContent>
                                    </Select>
                                    <FormMessage />
                                </FormItem>
                            )}
