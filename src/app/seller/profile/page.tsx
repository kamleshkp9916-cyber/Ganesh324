...
const mockSellers: Record<string, UserData> = {
    'fashionfinds-uid': { uid: 'fashionfinds-uid', displayName: 'FashionFinds', email: 'fashion@finds.com', photoURL: 'https://placehold.co/128x128.png?text=F', role: 'seller', followers: 1200, following: 150, bio: 'Curator of vintage and modern fashion.', location: 'Paris, France', phone: '', addresses: [], color: '#ffffff', instagram: 'https://instagram.com/fashionfinds', twitter: 'https://twitter.com/fashionfinds' },
    'gadgetguru-uid': { uid: 'gadgetguru-uid', displayName: 'GadgetGuru', email: 'guru@gadgets.com', photoURL: 'https://placehold.co/128x128.png?text=G', role: 'seller', followers: 2500, following: 50, bio: 'Latest and greatest in tech reviewed.', location: 'San Francisco, USA', phone: '', addresses: [], color: '#ffffff', youtube: 'https://youtube.com/gadgetguru' },
    'homehaven-uid': { uid: 'homehaven-uid', displayName: 'HomeHaven', email: 'contact@homehaven.com', photoURL: 'https://placehold.co/128x128.png?text=H', role: 'seller', followers: 850, following: 200, bio: 'Making your house a home, one decor piece at a time.', location: 'Stockholm, Sweden', phone: '', addresses: [], color: '#ffffff', facebook: 'https://facebook.com/homehaven' },
    'beautybox-uid': { uid: 'beautybox-uid', displayName: 'BeautyBox', email: 'info@beautybox.com', photoURL: 'https://placehold.co/128x128.png?text=B', role: 'seller', followers: 3100, following: 80, bio: 'Your one-stop shop for cosmetics and skincare.', location: 'Seoul, South Korea', phone: '', addresses: [], color: '#ffffff', instagram: 'https://instagram.com/beautybox', youtube: 'https://youtube.com/beautybox' },
    ...
    'fitflow-uid': { uid: 'fitflow-uid', displayName: 'FitFlow', email: 'getfit@fitflow.com', photoURL: 'https://placehold.co/128x128.png?text=F', role: 'seller', followers: 1500, following: 300, bio: 'Activewear and equipment for your fitness journey.', location: 'Los Angeles, USA', phone: '', addresses: [], color: '#ffffff', instagram: 'https://instagram.com/fitflow' },
    ...
    'petpalace-uid': { uid: 'petpalace-uid', displayName: 'PetPalace', email: 'woof@petpalace.com', photoURL: 'https://placehold.co/128x128.png?text=P', role: 'seller', followers: 1800, following: 220, bio: 'Everything your furry friends could ever want.', location: 'London, UK', phone: '', addresses: [], color: '#ffffff', facebook: 'https://facebook.com/petpalace' },
    'booknook-uid': { uid: 'booknook-uid', displayName: 'BookNook', email: 'read@booknook.com', photoURL: 'https://placehold.co/128x128.png?text=B', role: 'seller', followers: 620, following: 500, bio: 'A cozy corner for book lovers.', location: 'Edinburgh, Scotland', phone: '', addresses: [], color: '#ffffff', twitter: 'https://twitter.com/booknook' },
    'gamerguild-uid': { uid: 'gamerguild-uid', displayName: 'GamerGuild', email: 'gg@gamerguild.com', photoURL: 'https://placehold.co/128x128.png?text=G', role: 'seller', followers: 4200, following: 10, bio: 'Top-tier gaming gear and accessories.', location: 'Taipei, Taiwan', phone: '', addresses: [], color: '#ffffff', twitch: 'https://twitch.tv/gamerguild', youtube: 'https://youtube.com/gamerguild' },
};
