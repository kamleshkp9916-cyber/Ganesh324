...
import { Search, MoreVertical, MessageSquare, ShieldCheck, Menu, User, Users, ArrowLeft } from 'lucide-react';
...
export default function AdminMessagePage() {
  ...
  return (
    <AdminLayout>
        <main className="grid flex-1 items-start md:gap-8 h-[calc(100vh-120px)] md:h-[calc(100vh-100px)]">
