      ...
      <main className="flex-grow p-4 md:p-8">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mt-2">Welcome to StreamCart, a new way to experience online shopping.</p>
          </div>

          <p className="text-muted-foreground">Founded on January 1, 2025 by Ganesh Prajapati, StreamCart was born from a vision: to transform traditional e-commerce into something more interactive, engaging, and trustworthy. Shopping online often feels impersonal, with buyers left guessing about the quality of products. We wanted to change that.</p>
          <p className="text-muted-foreground">At StreamCart, we combine the power of live streaming with the convenience of e-commerce. Our platform allows sellers to showcase their products in real time while buyers can interact, ask questions, and see products in action before making a purchase. At the same time, customers can explore and buy from our listed product collections, making the entire experience smooth, social, and reliable.</p>
          ...
          <div>
            <h3 className="text-2xl font-semibold text-foreground mb-4">Why StreamCart?</h3>
          ...
          <div>
            ...
            <p className="text-muted-foreground">We aim to become the go-to platform for live commerce, where buyers and sellers connect in a trusted, engaging marketplace. As technology evolves, so will StreamCart — always keeping people at the center of commerce.</p>
          </div>

          <div className="border-t pt-8">
            <h3 className="text-2xl font-semibold text-foreground mb-4">A Note from Our Founder</h3>
            <blockquote className="border-l-4 pl-4 italic text-muted-foreground">
              <p>"I started StreamCart with a simple belief: online shopping should feel as real and trustworthy as buying something in person. Too often, people purchase products online only to be disappointed when the item arrives. With live streaming, customers can see the product in action, ask questions directly, and shop with confidence.</p>
              <p className="mt-4">StreamCart isn’t just about buying and selling — it’s about building trust, creating connections, and making shopping fun again. My goal is to give both sellers and buyers a platform that feels alive, interactive, and community-driven.</p>
